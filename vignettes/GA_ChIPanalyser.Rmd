...
```{r GA_params, class.source = 'fold-hide' eval = FALSE, echo = TRUE}
# Number of individuals per generation 
pop <- 100 
...
```{r plotOccup, eval = TRUE, echo = TRUE,fig.height= 10, fig.width=8,fig.show=TRUE}
pdf("test.pdf",height=12,width=8.5)
par(mfrow = c(5,1))
