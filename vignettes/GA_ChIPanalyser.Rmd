---
title: "The ChIPanalyser User's Guide for Genetic Algorithms"
...
inferred by maximizing or minimizing a goodness of fit score between real ChIP
...
# Work Flow
## Loading Data
The data sets contained within ChIPanalyser represents a minimal workable
examples for the different functions. All data is derived from real biological
data in *Drosophila melanogaster* (The *Drosophila melanogaster*
...
DNASequenceSet, PFM, Access,CS, geneRef, eveLocus, eveLocusChip.
...
* `CS` is a `GRanges` object containing chromatin states for
the sequence above.
...
`eveLocusChip` can be a connection to your ChIP data, a GRanges of your ChIP data or data frame (_bed_ format style)
