...
setMethod(
    "PositionWeightMatrix", "genomicProfilesInternal",
...
setReplaceMethod(
    ...
    signature(
        object = "genomicProfilesInternal",
        value = "matrix"
    ),
...
setMethod(
    "PositionFrequencyMatrix", "genomicProfilesInternal",
...
setMethod(
    "PFMFormat", "genomicProfilesInternal",
...
setMethod(
    "BPFrequency", "genomicProfilesInternal",
...
setMethod(
    "minPWMScore", "genomicProfilesInternal",
    function(object) object@minPWMScore
)
setReplaceMethod(
    ".minPWMScore", signature(
        object = "genomicProfilesInternal",
        value = "vector"
    ),
    function(object, value) {
...
setMethod(
    "maxPWMScore", "genomicProfilesInternal",
    function(object) object@maxPWMScore
)

setReplaceMethod(
    ".maxPWMScore", signature(
        object = "genomicProfilesInternal",
        value = "vector"
    ),
    function(object, value) {
...
setMethod(
    "profiles", "genomicProfilesInternal",
...
setMethod(
    "DNASequenceLength", "genomicProfilesInternal",
...
setMethod(
    "averageExpPWMScore", "genomicProfilesInternal",
    function(object) object@averageExpPWMScore
)

setReplaceMethod(
    ".averageExpPWMScore", signature(
        object = "genomicProfilesInternal",
        value = "numeric"
    ),
    function(object, value) {
...
setMethod(
    "PWMpseudocount", "parameterOptions",
...
setMethod(
    "boundMolecules", "parameterOptions",
...
setMethod(
    "backgroundSignal", "parameterOptions",
...
setMethod(
    "removeBackground", "parameterOptions",
...
setMethod(
    ".ZeroBackground", "parameterOptions",
...
setMethod(
    "noiseFilter", "parameterOptions",
    function(object) object@noiseFilter
)


setMethod(
    ".paramTag", "parameterOptions",
