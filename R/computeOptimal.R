computeOptimal <- function(
  genomicProfiles, DNASequenceSet, ChIPScore, chromatinState = NULL,
  ...
  peakMethod = "moving_kernel", cores = 1
    ...
    if (length(boundMolecules(genomicProfiles)) < 2) {
        boundMolecules(genomicProfiles) <- c(
            1, 10, 20, 50, 100,
