...
top <- lapply(KingOfTheHill[[1]]@profiles[[1]][1:10], function(k){
...
#### Getting DNASequenceSet that matches those regions
dna <-  getSeq(BSgenome.Dmelanogaster.UCSC.dm6)[top]
...
save(top,dna,chip,cs,access, file = "/home/patrickmartin/ChIPanalyser/ChIPanalyserData.Rda")
